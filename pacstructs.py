...
class PacMan(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("data/pacmanright.png").convert()
    ...
    def draw(self, screen):
        if self.dir == 'r': # moving right
            ...
            self.image = pygame.image.load("data/pacmanleft.png").convert()
        elif self.dir == 'd': # moving down
            self.image = pygame.image.load("data/pacmandown.png").convert()
        elif self.dir == 'u': # moving up
            self.image = pygame.image.load("data/pacmanup.png").convert()
...
class Ghost(pygame.sprite.Sprite):
    ...
    def __init__(self, color):
        super().__init__()
        if color == "orange":
            self.image = pygame.image.load("data/OrangeGhost.png").convert()
            self.image.set_colorkey(WHITE)
        elif color == "red":
            self.image = pygame.image.load("data/RedGhost.png").convert()
            self.image.set_colorkey(WHITE)
        elif color == "green":
            self.image = pygame.image.load("data/GreenGhost.png").convert()
            self.image.set_colorkey(WHITE)
